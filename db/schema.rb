...
ActiveRecord::Schema.define(version: 2023_06_07_034144) do
  ...
  create_table "commentReplies", force: :cascade do |t|
    t.integer "post_comment_id"
    t.text "reply_comment", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["post_comment_id"], name: "index_commentReplies_on_post_comment_id"
  end
  ...
  add_foreign_key "commentReplies", "post_comments"
